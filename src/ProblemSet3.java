...
public class ProblemSet3 {
	...
	public void fizzString(String str) {
		...
		if (str.charAt(0) == 'f' && str.charAt(length) == 'b') {
		...
		else if (str.charAt(0) != 'f' && str.charAt(length) != 'b'){
	...
	public void factorialWithFor(int n) {
		...
		System.out.println(originalN + "! = " + sum + ".");
	}
